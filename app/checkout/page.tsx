...
export default function CheckoutPage() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      // NO borrar el carrito aquí - se borrará en la página de éxito después de confirmar el pago
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-zinc-900 p-6 rounded-lg">
              <h2 className="text-2xl font-bold mb-6">Información del Contacto</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full bg-zinc-800 border ${errors.firstName ? 'border-red-600' : 'border-zinc-700'} rounded px-4 py-3 focus:outline-none focus:border-red-600`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full bg-zinc-800 border ${errors.lastName ? 'border-red-600' : 'border-zinc-700'} rounded px-4 py-3 focus:outline-none focus:border-red-600`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full bg-zinc-800 border ${errors.email ? 'border-red-600' : 'border-zinc-700'} rounded px-4 py-3 focus:outline-none focus:border-red-600`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full bg-zinc-800 border ${errors.phone ? 'border-red-600' : 'border-zinc-700'} rounded px-4 py-3 focus:outline-none focus:border-red-600`}
                  />
                  ...
                  <label className="block text-sm font-semibold mb-2">
                    ...
                    {isLoaded && (
                      <span className="text-zinc-400 text-xs ml-2">
                        (Empieza a escribir para buscar tu dirección)
                      </span>
                    )}
                  </label>
                  {isLoaded ? (
                    ...
                    >
                      <input
                        ...
                        className={`w-full bg-zinc-800 border ${errors.address ? 'border-red-600' : 'border-zinc-700'} rounded px-4 py-3 focus:outline-none focus:border-red-600`}
                      />
                    </Autocomplete>
                  ) : (
                    <input
                ...
                <div>
                  ...
                  <input
                    ...
                    value={formData.city}
                    onChange={handleInputChange}
                    className={`w-full bg-zinc-800 border ${errors.city ? 'border-red-600' : 'border-zinc-700'} rounded px-4 py-3 focus:outline-none focus:border-red-600`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full bg-zinc-800 border ${errors.state ? 'border-red-600' : 'border-zinc-700'} rounded px-4 py-3 focus:outline-none focus:border-red-600`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full bg-zinc-800 border ${errors.zipCode ? 'border-red-600' : 'border-zinc-700'} rounded px-4 py-3 focus:outline-none focus:border-red-600`}
                  />
            ...
            <div className="bg-zinc-900 p-6 rounded-lg">
              ...
              <p className="text-zinc-400 text-sm mb-6">
                Seras redirigido a la página de Stripe&apos;s para completar tu pago.
              </p>
              
              {/* Security Badges */}
              <div className="flex items-center gap-4 mb-6 text-zinc-400 text-xs">
              ...
              <button
                ...
                className={`
                  ...
                  text-white
                  focus:outline-none focus:ring-2 focus:ring-[#635BFF] focus:ring-offset-2 focus:ring-offset-zinc-900
                `}
                style={{
              ...
              <div className="flex items-center justify-center gap-2 mt-4">
                <span className="text-zinc-500 text-xs">Asegurado por </span>
              ...
              <p className="text-center text-zinc-500 text-xs mt-3">
                Tu información de pago sera procesada de manera segura. Nosotros no guardamos detalles de la tarjerta.
              </p>
            </div>
          </div>
